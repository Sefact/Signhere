...
<head>
	...
	<!-- Font-Awesome -->
	<link href="//netdna.bootstrapcdn.com/font-awesome/4.0.3/css/font-awesome.css" rel="stylesheet">sheet">
	<!-- Resources CSS -->
...
<body>
	...
	<h1 class="page-header">공문 수신함</h1>
	...
	<form>
		...
		<div class="table-responsive">
			...
			<c:forEach var="docList" items="${docList}">
				<tr>
					...
					<td><c:out value="${docList.cmName }"/></td>
					<td><c:out value="${docList.writer }"/></td>
		...
		<ul class="btn-group pagination">
				    ...
				    <li>
				        <a href='<c:url value="/receiveList?page=${pagination.startPage-1 }"/>'><i class="fa fa-chevron-left"></i></a>
				    </li>
				    </c:if>
				    <c:forEach begin="${pagination.startPage }" end="${pagination.endPage }" var="pageNum">
				    <li>
				        <a href='<c:url value="/receiveList?page=${pageNum }"/>'><i class="fa">${pageNum }</i></a>
				    </li>
				    </c:forEach>
				    <c:if test="${pagination.next && pagination.endPage >0 }">
				    <li>
				        <a href='<c:url value="/receiveList?page=${pagination.endPage+1 }"/>'><i class="fa fa-chevron-right"></i></a>
				    </li>
				    </c:if>
		</ul>
	</div>
